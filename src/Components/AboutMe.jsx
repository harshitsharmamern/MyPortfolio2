        ...
        <div id='about-me' className='bg-[#212529] min-h-screen relative'>
            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-10 px-8 pt-20 text-white">
                <div className="lg:col-span-2 space-y-5">
                    ...
                    <h1 className='text-xl md:text-3xl font-bold'>I'm <span className='font-medium text-[#20c997]'>Harshit Sharma,</span> a MERN Stack Developer.</h1>
                    ...
                    working on machine learning <br /> <br />
                ...
                <div className=" md:text-lg space-y-4">
                    <h1 className='text-[#20c997]'><span className='font-bold text-white'>Name:</span> Harshit Sharma</h1>
                    <hr className='h-[1px] border-[#3e444b]' />
                    <h1 className='text-[#20c997]'><span className='font-bold text-white'>Email:</span> sharmaharshit769@gmail.com</h1>
                    <hr className='h-[1px] border-[#3e444b]' />
                    <h1><span className='font-bold'>Age:</span> 23</h1>
                    <hr className='h-[1px] border-[#3e444b]' />
                    <h1 className=''><span className='font-bold'>From:</span> Bhopal, India</h1>
                    <div>
                        <a href={harshit_pdf} className='py-3 px-6 bg-[#20c997] hover:bg-[#1baa80] transition-all transition-0.5s ease-in text-white rounded-full'>Download CV</a>
                    </div>
                </div>
            </div>
